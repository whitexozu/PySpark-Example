...
if __name__ == "__main__":
    ...
    ef = executeFun()
    ss = ef.getSparkSession("insert ta_customer_sblt", sys.argv[1])
    ...
    createTableSql = []
    createTableSql.append("CREATE TABLE IF NOT EXISTS ta_customer_sblt ")
    ...
    createTableSql.append(") ")
    createTableSql.append("partitioned by (camp_start_dt string, insrcomp_cd string, brch_cd string) ")
    ...
    try :
        for insrcompCd in insrcompCdArray:
            for brchCd in brchCdArray:
                ...
                selectQueryArray.append("            if(emo_pos == 0 and emo_eng == 0, 0, emo_pos / (emo_pos + emo_eng) * 100) as iptc ")
                ...
                if resultDf.count() > 0 :
                    ...
                    for t in resultDf.collect():
                        try:
                            print('{0}|{1}|{2}|{3}|{4}|{5}|{6}|{7}'.format(t[0], t[1], t[2], t[3], t[4], campStartDt, insrcompCd, brchCd))
                            if t[4] == None:
                                t[4] = 0.0
                            insertRows.append([t[0], t[1], t[2], t[3], t[4], campStartDt, insrcompCd, brchCd])
                    ...
                    insertDf.write.format("orc").insertInto("ta_customer_sblt")
